              ...
              <li className="nav-item dropdown">
                    ...
                    >
                      <div className="container  ">
                        <div className="row ">
                          <div className="col  ">
                            <Link className="dropdown-item " to={"/approvedLeaveList"}>
                              <div className="dropdown-content ">
                              <i class="fa-solid fa-check text-green mr-2"></i>
                                <span> Onaylanan İzin İstekleri</span>
                              </div>
                            </Link>
                          </div>
                          <div className="col">
                            <Link className="dropdown-item" to={"/pendingLeaveList"}>
                              <div className="dropdown-content ">
                              <i class="fa-solid fa-hourglass-start text-yellow mr-2"></i><span> Bekleyen İzin Listele</span>
                              </div>
                            </Link>
                          </div>
                          <div className="col">
                            <Link className="dropdown-item" to={"/rejectLeaveList"}>
                              <div className="dropdown-content ">
                              <i class="fa-solid fa-x text-red mr-2"></i><span> Reddedilen İzin Listele</span>
                              </div>
                            </Link>
                          </div>
                        </div>
