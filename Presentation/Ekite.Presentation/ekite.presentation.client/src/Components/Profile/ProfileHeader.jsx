      ...
      <span
        className={
          darkMode
            ...
            : "mask bg-gradient-default opacity-4"
        }
      ></span>
      <div className="container-fluid d-flex align-items-center">
        <div className="row">
          {userRole === "Admin" ? (
            <>
              <div
                className={darkMode ? "col-lg-12" : "col-lg-12 bg-dark"}
                style={
                  darkMode
                    ? {}
                    : {
              ...
              >
                <h1 className="display-2 text-white">Şirket Yöneticisi</h1>
              </div>
            </>
          ) : userRole === "SiteOwner" ? (
            <div
            ...
            >
              <h1 className="display-2 text-white">Site Yöneticisi</h1>
            </div>
          ) : (
            <>
