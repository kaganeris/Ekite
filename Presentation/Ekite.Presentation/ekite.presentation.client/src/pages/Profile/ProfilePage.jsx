      ...
      {profileData ? (
        <div className={darkMode ? "main-content" : "main-content bg-dark"} id="panel">
          ...
          <div className="container-fluid mt--6">
            <div className="row ">
              <div className={userRole === "Employee" ? "col-xl-4 order-xl-1" : userRole === "SiteOwner" ? "col-xl-4 order-xl-1" : "col-xl-6 order-xl-1"}>
                  {userRole === "Employee"  ? (
              ...
              <div className={userRole === "Employee" ? "col-xl-8 order-xl-1" : userRole === "SiteOwner" ? "col-xl-8 order-xl-1" : "col-xl-6 order-xl-1"}>
